  ...
  return (
    <section class="L_showcase cursor-light" id="product1">
      <div class="L_text">
        ...
        <p>
          Hyper Jump – Jump into Joy! Step into a new era of interactive entertainment with Hyper Jump—a revolutionary trampoline experience that fuses cutting-edge technology with high-energy fun.
        </p>
      </div>
    </section>
  );
